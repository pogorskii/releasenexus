...
use App\Jobs\ConnectGameThemesJob;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\Bus;

class ConnectGameThemes extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'igdb:connect-game-themes';
    /**
    ...
    public function handle(): void
    {
        try {
            ...
            $chunkNumber = 0;
            do {
                $job = new ConnectGameThemesJob($chunkNumber);
                Bus::dispatch($job);
                $chunkNumber++;

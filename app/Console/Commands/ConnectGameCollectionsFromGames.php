...
use App\Jobs\ConnectGameCollectionsFromGamesJob;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\Bus;

class ConnectGameCollectionsFromGames extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'igdb:connect-game-collections-from-games';
    /**
    ...
    public function handle(): void
    {
        try {
            ...
            $chunkNumber = 0;
            do {
                $job = new ConnectGameCollectionsFromGamesJob($chunkNumber);
                Bus::dispatch($job);
                $chunkNumber++;

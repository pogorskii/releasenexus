...
use App\Jobs\ConnectGameModesJob;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\Bus;

class ConnectGameModes extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'igdb:connect-game-modes-job';
    /**
    ...
    public function handle(): void
    {
        try {
            ...
            $chunkNumber = 0;
            do {
                $job = new ConnectGameModesJob($chunkNumber);
                Bus::dispatch($job);
                $chunkNumber++;

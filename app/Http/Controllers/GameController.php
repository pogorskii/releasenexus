...
//        })->sortBy('date')->values();
        ...
        $releasingOnSpecificDate = GReleaseDate::with('dateable.covers.image', 'platform')->whereYear('date', $year)->whereMonth('date', $month)->where('category', '0')->get();
        ...
        $releasingThisMonth   = GReleaseDate::with('dateable.covers.image', 'platform')->whereYear('date', $year)->whereMonth('date', $month)->where('category', '1')->get();

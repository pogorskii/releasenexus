...
use App\Actions\Games\ConnectGameCollectionsFromGamesAction;
...
class ConnectGameCollectionsFromGamesJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            $result  = ConnectGameCollectionsFromGamesAction::execute($records);

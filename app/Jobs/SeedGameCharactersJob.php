...
class SeedGameCharactersJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            $records = FetchGameCharactersAction::execute($this->chunkNumber, 'id asc');
            $result  = AddGameCharactersAction::execute($records);

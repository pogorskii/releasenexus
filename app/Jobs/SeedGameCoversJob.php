...
use App\Actions\Games\AddGameCoversAction;
...
class SeedGameCoversJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            $records = FetchGameCoversAction::execute($this->chunkNumber, 'id asc', ['*']);
            $result  = AddGameCoversAction::execute($records);

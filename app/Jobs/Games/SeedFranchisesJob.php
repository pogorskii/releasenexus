...
use App\Actions\Games\AddFranchisesAction;
...
class SeedFranchisesJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            $records = FetchFranchisesAction::execute($this->chunkNumber, 'id asc');
            $result  = AddFranchisesAction::execute($records);
